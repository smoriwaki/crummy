...
class StandardRendererTest < Test::Unit::TestCase
  ...
  def test_classes
    ...
    assert_equal('<ul class="" id=""><li class="first"><a href="url1">name1</a></li><li class="separator">/</li><li class="li_class"><a href="url2">name2</a></li><li class="separator">/</li><li class="last"><a href="url3">name3</a></li></ul>',
                 renderer.render_crumbs([['name1', 'url1'], ['name2', 'url2'], ['name3', 'url3']], :li_class => "li_class", :first_class => 'first', :last_class => 'last', :separator => '<li class="separator">/</li>', :format => :html_list))
